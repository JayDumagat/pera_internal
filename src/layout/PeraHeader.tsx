...
const PeraHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-99999 w-full bg-white border-gray-200 dark:border-gray-800 dark:bg-gray-900 xl:border-b">

      {/* ==========================================
          1. MOBILE DESIGN (Hidden on desktop via xl:hidden)
          Borderless, Avatar on left with name text, Notification bar on right.
         ========================================== */}
      <div className="flex items-center justify-between w-full h-16 px-4 xl:hidden sm:px-6">
        {/* Left Side: Avatar + Typography Grid are handled automatically by UserDropdown */}
      ...
      {/* ==========================================
          2. DESKTOP DESIGN (Hidden on mobile via hidden xl:flex)
          Retains your exact layout, logo structure, sidebar toggles, and forms.
         ========================================== */}
      <div className="hidden xl:flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
